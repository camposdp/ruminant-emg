...
%Não balanceado
mdl_LDA_Tv = fitcdiscr(Xv,YT);
evi(:,j) = kfoldLoss(crossval(mdl_LDA_Tv),'Mode','individual');

mdl_LDA_Tf = fitcdiscr(Xf,YT);
efi(:,j) = kfoldLoss(crossval(mdl_LDA_Tf),'Mode','individual');
...
%Não balanceado
mdl_LDA_Tv = fitcdiscr(Xv,YT);
ev(:,i) = kfoldLoss(crossval(mdl_LDA_Tv),'Mode','individual');

mdl_LDA_Tf = fitcdiscr(Xf,YT);
ef(:,i) = kfoldLoss(crossval(mdl_LDA_Tf),'Mode','individual');
